...
from .contracts import Startable, Stoppable
from .exceptions import ServiceAlreadyRegisteredError, ServiceResolutionError
from .lifelines import SINGLETON, SCOPED, TRANSIENT
...
class ServiceContainer:
    ...
    def register(self, contract: Type[Contract], implementation: Type[Contract], lifetime: str = SINGLETON) -> None:
        """
        ...
        if lifetime not in {SINGLETON, SCOPED,TRANSIENT}:
    ...
    def register_singleton(self, contract: Type[Contract], implementation: Type[Contract]) -> None:
        ...
        self.register(contract, implementation, SINGLETON)
    ...
    def register_transient(self, contract: Type[Contract], implementation: Type[Contract]) -> None:
        ...
        self.register(contract, implementation, TRANSIENT)
    ...
    def register_scoped(self, contract: Type[Contract], implementation: Type[Contract]) -> None:
        ...
        self.register(contract, implementation, SCOPED)
    ...
    def get(self, contract: Type[Contract]) -> Contract:
        ...
        This method is the djangospice of the registry. It handles caching for singletons,
    ...
    def start_singletons(self) -> None:
        ...
        for contract, (impl, lifetime) in self._registry.items():
            if lifetime == SINGLETON and contract not in self._singletons:
                self.get(contract)
                
        for inst in self._singleton_order:
            if isinstance(inst, Startable):
                try:
                    inst.start()
