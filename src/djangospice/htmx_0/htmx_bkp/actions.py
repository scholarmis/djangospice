...
from .redirects import htmx_data_refresh
...
class BulkAction(BaseAction):
    ...
    def is_allowed(self, request, row_ids) -> bool:
       return super().is_allowed(request, row_ids)
...
class DeleteTableRows(BulkAction):
    ...
    def handle(self, view, request, row_ids: List[Any]):
        ...
        return htmx_data_refresh(request)
