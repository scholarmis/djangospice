...
from djarf.tables.columns import CustomCheckBoxColumn
...
class BaseTable(tables.Table):
    ...
    def get_row_menu(self, record):
        ...
        # 1. Get the row action objects
        row_actions: list[RowAction] = getattr(view, "row_actions", [])
        ...
        actions = [
            ...
            for action in sorted(
                [a for a in row_actions if a.is_allowed(request, record)],
